            ...
            <CardDeck>
                <Card>
                    <CardBody>
                        ...
                        <CardText tag="h6">Stocks are unpredicatble and always fluctuating. That's why our website provides all the latest predictions on future stock prices so you can make the most informed buying decisions.</CardText>
                    </CardBody>
                </Card>
                <Card>
                    <CardBody>
                        ...
                        <CardText tag="h6">Get all the information you need about current stocks, including stock prices and price changes, in an clear and easy to read format.</CardText>
                    </CardBody>
                </Card>
                <Card>
                    <CardBody>
                        ...
                        <CardText tag="h6">Our website provides the latest news on important developments, including changes in weather, company updates, and current events.</CardText>
                    </CardBody>
                </Card>
            </CardDeck>
